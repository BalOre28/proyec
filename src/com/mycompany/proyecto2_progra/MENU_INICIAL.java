...
public class MENU_INICIAL extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 170, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Login OpcionLogin=new Login();
        OpcionLogin.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        RegistrarUsuarios OpcionCrearUsuario=new RegistrarUsuarios(this,true);
        OpcionCrearUsuario.setVisible(true);
        this.setVisible(false);
